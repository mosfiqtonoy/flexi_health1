...
from services.auth_service import register_user, authenticate_user, reset_password, initiate_password_reset
...
def api_register():
    ...
    success, message = register_user(
        full_name, email, phone, password, blood_group, dob, address, latitude, longitude
    )
